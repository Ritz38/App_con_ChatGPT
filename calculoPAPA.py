...
st.write("El formato para cada materia del archivo csv es: Asignatura,Calificación,Créditos,Tipología. Ademas de que se debe agregar el nombre a las columnas asi: Asignatura,Calificación,Créditos,Tipología")
st.write("""
    Ejemplo:
